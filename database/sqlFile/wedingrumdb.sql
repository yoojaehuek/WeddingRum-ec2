...
-- 테이블 데이터 wedingrumdb.products:~20 rows (대략적) 내보내기
...
-- 테이블 데이터 wedingrumdb.reservations:~0 rows (대략적) 내보내기
