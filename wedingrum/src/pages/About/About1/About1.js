        ...
        <div className="A1maintxt">
          <div className="left">
            <p>
              유모멘트는 웨딩 서비스를<br/>  
              비롯하여 인생 중요한<br/>
              모멘트에서의 라이프 스타일을 제안하는<br/>
              서비스 전문 기업입니다.
            </p>  
          </div>
          <div className="right">
            <p>
              (주)유모멘트는 2011년 설립되어 더채플 브랜드로 웨딩홀을 운영하는 유모멘트 유한회사와 2016년 7월 CJ 푸드빌로 물적 분할되어<br/>
              설립되었습니다. 또한 아펠가모 주식회사를 통합하여, 현재 '더채플(The Chapel)', '아펠가모(apelgamo)', '루벨(LUVEL)'이라는 3개의<br/>
              웨딩홀 브랜드를 운영 중입니다. 3개의 브랜드는 모두 서울지역에서 운영 중이며, 총 8개 점포 11개의 웨딩홀을 소유하고 있습니다.<br/><br/>
              (주)유모멘트는 2022년 말까지 총 3만 건 이상의 웨딩을 진행하고, 매년 150만 명이 넘는 하객을 맞이함으로써 명실공히 국내 최대,<br/>
              최고의 서비스를 자랑하는 프리미엄 웨딩홀 가치를 인정받고 있습니다.<br/><br/>
              또한 웨딩 서비스뿐만 아니라 다양한 인생의 중요한 순간에서 고객에게 행복한 '모멘트'를 만들어 드리고자 외식, 뷰티,<br/>
              플랫폼 서비스 등 다양한 라이프 스타일을 제공하고 있습니다.<br/><br/>
